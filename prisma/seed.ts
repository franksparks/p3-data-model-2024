...
async function main() {
  ...
  console.log("Libraries created:", libraryOne, libraryTwo, libraryThree, libraryFour, libraryFive);
  ...
  console.log("Authors added:", authorOne, authorTwo, authorThree, authorFour, authorFive);
